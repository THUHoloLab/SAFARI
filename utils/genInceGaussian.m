function [IGB,X,Y] = genInceGaussian(L,N,parity,p,m,e,w0,k,z)
%{
...
For more information about Ince Polynomial:
    ...
    Miguel A. Bandres and Julio C. Guti閞rez-Vega, "Ince-Gaussian modes of the paraxial wave equation and stable resonators"
    Journal of the Optical Society of America A, 21(5), 873-880 (2004) ( http://goo.gl/rqq7nQ )
