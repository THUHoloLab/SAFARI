function [Uout] = genTurbulence(N,nscr,D1,D2,Dz,wvl)
% =========================================================================
% Generate synthetic turbulence.
% -------------------------------------------------------------------------
% Input:    - N    : Number of grid points per side (pixel).
%           - nscr : Number of phase screens.
%           - D1   : Length of one side of square phase screen (m).
%           - D2   : Diameter of the observation aperture (m).
%           - Dz   : Propagation distance (m).
%           - wvl  : Optical wavelength (m).
% Output:   - Uout : Complex amplitude of the wavefront.
% =========================================================================

options = optimoptions('fmincon','display','none');

% D1 = 2;   % length of one side of square phase screen [m]

delta = D1/N;    % grid spacing [m]
% spatial grid
x = (-N/2 : N/2-1) * delta;
y = x;
